Feature: Test all the functionalities of VirtualRoulette module in Suribet Website on Web version
   

    #VirtualRoulette_Web_Login_Home_Validations
...
#		Scenario: Load the suribet website with valid URL, verify login scenarios and home button functionalities
    ...
    #When Web: Open the chrome browser, Enter the valid suribet URL, Click on VirtualRoulette module link, enter valid and invalid login details and click on home button
    #Then Web: User should be blocked from logging to the suribet website
#		And Web: User should able to see the VirtualRoulette module link in the home page and should see VirtualRoulette module home page after login & clicking on VirtualRoulette module
#		And Web: User should be navigated to the Home page of suribet website after clicking on home link
	
	#VirtualRoulette_Web_Draw_BetNumbers_BetAmount_Verifications
	
	#Scenario: Verify basic functionalities of VirtualRoulette module like verifying current draw, bet numbers, place a bet without login, verify minimum bet, cross verify selected bet numbers and stake amount
	...
	#And Web: Selected Draw No#, Time on the VirtualRoulette module screen
	#And Web: Validation message for placing bet without login to the website
	#And Web: System should not allow user to enter the stake amount in whole numbers, It should be autocalculated in VirtualRoulette module


     #VirtualRoulette_Web_PlaceBet_CancelBet_BalanceRefresh_Validations

	#Scenario: Verify basic functionalities of VirtualRoulette module like Place bet can cancel the bet with the balance being updated for every bets
	...
	#And Web: After cancelling the placed bet validation message has to be generated and stake balance has be added to main account balance
     ...
     #VirtualRoulette_Web_CardLogin_RemoveBets_AccountDeatilsPageCancelBet_BalanceRefresh_Validation

	#Scenario: Verify functionalities of VirtualRoulette module like login via gmail and switch to card, place bet, remove certain placed bet and later cancel via account details page
    ...
    #When Web: Login to suribet website with valid login details, Click on VirtualRoulette module link, change to card mode of payment
	...
	#And Web: Cancel the placed bet and accept all the alerts with validation messages and verify the amount being deposited and refreshed after cancelling the bets in Virtual Roulette module


	#VirtualRoulette_Web_PaybyCard_Place_Cancel_Bets_TimeLapseCancelBets_Validations
	
    #Scenario: Verify functionalities of VirtualRoulette module like pay by card functionality
    ...
    #When Web: Login to suribet website with valid login details, Click on VirtualRoulette module link and place bet 
	...
	#And Web: Successfull cancelling bet user message is displayed to user in Virtual Roulette module
	...
	#VirtualRoulette_Web_ClearBets_IncreaseOrDecrease_Stake_Validations
	
    #Scenario: Verify basic functionalities of VirtualRoulette module like clear All, clear individual, increase or decrease stake amount individually, 	
	...
	#VirtualRoulette_Web_ChipDenominations_LockAndUnlock_ReplayButton_Validations
	
    #Scenario: Verify functionalities of VirtualRoulette module like replay button, chip denominations, chip bets lock and unlock state on roulette table numbers under place and cancelling bets
	...
	#VirtualRoulette_Web_ChipDenominations_Addition_RefreshPage_Validations
	
	#Scenario: Verify functionalities of VirtualRoulette module like chip denominations, chip bets lock and unlock state on roulette table numbers under refreshpage, navigation to other sites and after re-login to virtual roulette module having previously selected draw num
	...
	#VirtualRoulette_Web_Search_DrawResult_Validations
	
	#Scenario: Verify functionalities of VirtualRoulette module like draw result tab under various inputs
	...
	#VirtualRoulette_Web_MulripleDraws_PlaceBet_CancelBet_Validations
	
	 #Scenario: Verify functionalities of VirtualRoulette module like Multiple draws place bet and cancel bet individually and check the balance after cancelling
	...
	#VirtualRoulette_Web_CardLogin_TimeLapseCancelBets_BalanceUpdate_Validations
	
	#Scenario: Verify functionalities of VirtualRoulette module like timelapse cancel bet balance updation in card login mode of transactions
    ...
    #Then Web: Validate balance refresh functionality and bet status with time period for cancelation of bets via card login
	 ...
	 #VirtualRoulette_Web_OnlineLogin_TimeLapseCancelBets_BalanceUpdate_Validations
	
	#Scenario: Verify functionalities of VirtualRoulette module like timelapse cancel bet balance updation in online login mode of transactions
	...
	#VirtualRoulette_Web_OnlineLogin_BarCodeField_GameInfo_Validations

	#Scenario: Verify functionalities of VirtualRoulette module like barcode and slip id details
	...
	#VirtualRoulette_Web_OnlineLogin_HideAndUnhide_BettingSlip_AllDraws_AccountOpenAndCloseBalance_Validations
	
	#Scenario: Verify functionalities of VirtualRoulette module like hide and unhide the BettingSlip and AllDraws sections and the open and close balance after login and logout and re-login with successfull and cancelling bets combinations validations
	...
	#VirtualRoulette_Web_InvalidLogin_Validations
...
#		Scenario: Verify the invalid login validation messages under all login modes 
	...
	#VirtualRoulette_Web_OnlineLogin_StatitcsResults_BetPlace_AfterTimeLapse_RemoveAllButton_Validations
	...
	#VirtualRoulette_Web_BetTableDetails_BetSlipCrossVerification_Language_Validations
	
	#Scenario: Verify the bet details table above the roulette table, cross verify the bet selected in roulette table is same displayed on betting slip and the language change 
	...
	#VirtualRoulette_Web_AccountSummaryPage_Validations
