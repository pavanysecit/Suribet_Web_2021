...
public class Web_Skinfiri_MulripleDraws_PlaceBet_CancelBet_Validations extends Web_Skinfiri_URL_OnlineLogin {
	WebDriver driver;

	public Web_Skinfiri_MulripleDraws_PlaceBet_CancelBet_Validations() throws Exception {
	...
	public void web_Chrome_browser_suribet_website_valid_URL_skinfiri_module_login_via_online_method_upcoming_matches_table_place_for_multiple_draws_cancel_slip() throws Throwable {
	...
	public void web_Login_to_skinfiri_and_place_bet_for_multiple_draws_and_try_cancelling_each_slips_and_multiple_cancelling_of_slips() throws Throwable {
		//clicking on Draw details to place bet for the current draw and cancwl
		WebElement upmatch1 = driver.findElement(By.xpath("//ul[@class='ul_clear in_R_up_ul  skinfri_class']/li[1]"));
		...
		WebElement Pick3 = driver.findElement(By.xpath("(//li[@class='skinfriBetIcon_27  Soldout'])[2]"));
