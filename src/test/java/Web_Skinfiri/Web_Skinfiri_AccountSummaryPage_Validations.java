...
public class Web_Skinfiri_AccountSummaryPage_Validations extends Web_Skinfiri_URL_OnlineLogin {
	WebDriver driver;
	
	public Web_Skinfiri_AccountSummaryPage_Validations() throws Exception {
	...
	public void web_Chrome_browser_suribet_website_valid_URL_sports_betting_module_valid_logins_Account_summary_page() throws Throwable {
	...
	public void web_Navigate_to_account_summary_page_and_modify_the_search_pattern_like_date_module_row_length() throws Throwable {
		...
		Thread.sleep(2000);
		WebElement sear = driver.findElement(By.xpath("//div[@class='homeICon fa fa-search']"));
		sear.click();
		Thread.sleep(8000);
		...
		String totalpage = newpage20.getText().substring(31, 32);
		...
		WebElement fwdpage = driver.findElement(By.xpath("(//span[@class='fa fa-angle-right'])")); 
		...
		WebElement fastfwdpage = driver.findElement(By.xpath("(//span[@class='fa fa-angle-double-right'])")); 
