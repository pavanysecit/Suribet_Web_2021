...
public class Web_Skinfiri_InvalidLogin_Validations extends Web_Skinfiri_URL{
	WebDriver driver;
	
	@Given("^Web: Chrome browser, suribet website valid URL, sports betting module, invalid login details$")
	public void web_Chrome_browser_suribet_website_valid_URL_sports_betting_module_invalid_login_details() throws Throwable {
	...
	public void web_Try_to_login_with_invalid_different_combinations_under_all_modes_of_login_methods() throws Throwable {
		...
		//Invalid account number login with different combinations
		login.clear();
		Thread.sleep(1000);
		login.sendKeys("9308481390");
		Thread.sleep(1000);
		...
		WebElement Pick2 = driver.findElement(By.xpath("//li[@class='skinfriBetIcon_3  Soldout']"));
		WebElement Pick28 = driver.findElement(By.xpath("//li[@class='skinfriBetIcon_13  Soldout']"));

		Pick2.click();
		Thread.sleep(1000);
		Pick28.click();
		Thread.sleep(1000);
		System.out.println("Bets selected on the Skinfiri table");

		//Selecting the pay by card for placing the bet
		WebElement stake = driver.findElement(By.xpath("//input[@ng-model='DailyGameCtrl._allStackVal']"));
		stake.click();
		stake.sendKeys("1");
//		Thread.sleep(1000);
//		stake.sendKeys("1");
