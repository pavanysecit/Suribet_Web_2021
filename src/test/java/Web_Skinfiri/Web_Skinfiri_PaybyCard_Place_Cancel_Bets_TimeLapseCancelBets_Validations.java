...
public class Web_Skinfiri_PaybyCard_Place_Cancel_Bets_TimeLapseCancelBets_Validations extends Web_Skinfiri_URL{
	WebDriver driver;
	...
	public void web_Chrome_browser_suribet_website_valid_URL_skinfiri_module_place_bet_and_pay_the_amount_via_card_PAY_BY_CARD_option() throws Throwable {
		driver = Web_Skinfiri_URL();
		Thread.sleep(2000);
	}

	@When("^Web: Login to suribet website with valid login details, Click on Skinfiri module link and place bet$")
	public void web_Login_to_suribet_website_with_valid_login_details_Click_on_Skinfiri_module_link_and_place_bet() throws Throwable {
...
//		Thread.sleep(1000);
		...
		Assert.assertEquals(numbal+4, numbal1, 0.000);
	...
	@Then("^Web: Successfull cancelling bet user message is displayed to user in Virtual sports betting module$")
	public void web_Successfull_cancelling_bet_user_message_is_displayed_to_user_in_Virtual_sports_betting_module() throws Throwable {
