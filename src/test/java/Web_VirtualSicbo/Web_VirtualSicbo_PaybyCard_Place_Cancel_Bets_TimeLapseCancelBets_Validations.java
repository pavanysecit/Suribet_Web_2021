...
public class Web_VirtualSicbo_PaybyCard_Place_Cancel_Bets_TimeLapseCancelBets_Validations extends Web_VirtualSicbo_URL{
WebDriver driver;
	...
	public void web_Login_to_suribet_website_with_valid_login_details_Click_on_VirtualSicbo_module_link_and_place_bet() throws Throwable {
		...
		WebElement cardpay = driver.findElement(By.xpath("(//div[@class='slip_but_w'])[2]"));
		...
		System.out.println("After cancelling the bet and card balance is: "+ cardbb);
	...
	public void web_Select_PAY_BY_CARD_option_and_fill_the_card_details_and_accept_the_pop_up() throws Throwable {
		...
		Assert.assertEquals(numbal, numbal1, 0.000);
...
//		//Assert.assertEquals("Time limit Passed!", cancelbet.getText());
	...
	@Then("^Web: Successfull cancelling bet user message is displayed to user in Virtual Sicbo module$")
	public void web_Successfull_cancelling_bet_user_message_is_displayed_to_user_in_Virtual_Sicbo_module() throws Throwable {
