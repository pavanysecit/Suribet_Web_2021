...
public class Lotto_Web_OnlineLogin_BarCodeField_GameInfo_Validations extends Lotto_Web_URL_OnlineLogin{
	WebDriver driver;
	...
	public void web_Chrome_browser_suribet_website_valid_URL_Lotto_module_login_via_online_method_place_bet_get_the_slip_ID_valid_and_invalid_input() throws Throwable {
	...
	public void web_Place_bet_and_get_the_slip_id_and_cancel_the_bet_and_input_the_same_slip_id_in_barcode_field_and_verify_the_status_and_the_fields_in_the_slip_generator() throws Throwable {
		...
		WebElement SlipID = driver.findElement(By.xpath("//li[@id='SlipIddlpDet']"));  
		...
		WebElement SD_status = driver.findElement(By.xpath("//li[@class='ng-binding cancelled']"));    
		...
		driver.findElement(By.xpath("(//*[@class='fa fa-times close_popup_JS'])[4]")).click();
		Thread.sleep(2000);


		// Log-off from the Lotto and search the slip 
		WebElement logoff = driver.findElement(By.xpath("//span[@class='log_off click_effect_JS']"));  
