...
public class Lotto_Web_AccountSummaryPage_Validations extends Lotto_Web_URL_OnlineLogin{
WebDriver driver;
		
	@Given("^Web: Chrome browser, suribet website valid URL, lotto module, valid logins, Account summary page$")
	public void web_Chrome_browser_suribet_website_valid_URL_lotto_module_valid_logins_Account_summary_page() throws Throwable {
	...
	public void web_Navigate_to_account_summary_page_and_modify_the_search_pattern_like_date_module_row_length() throws Throwable {
		...
		//Verifying the modules in the select dropdown	
		WebElement fdate = driver.findElement(By.xpath("//input[@ng-model='globalbetDetailsCtrl.FromDateKey']"));
		fdate.sendKeys("01/Jan/2021");
		Thread.sleep(2000);
		WebElement tdate = driver.findElement(By.xpath("//input[@ng-model='globalbetDetailsCtrl.ToDateKey   ']"));
		tdate.sendKeys("11/Aug/2021");
		Thread.sleep(2000);
		WebElement sear = driver.findElement(By.xpath("(//div[@class='homeICon fa fa-search'])[2]"));
		sear.click();
		Thread.sleep(8000);
		...
		prod.selectByVisibleText("Lotto");
		System.out.println("Selected Lotto product from the select dropdown");
		Thread.sleep(5000);
		...
		if(row1.getText().contains("Lotto")) {
		...
		Thread.sleep(5000);
		WebElement page20 = driver.findElement(By.xpath("(//*[@class='paginationGridRecordDisp ng-binding'])[2]"));
		...
		Thread.sleep(5000);
		WebElement page50 = driver.findElement(By.xpath("(//*[@class='paginationGridRecordDisp ng-binding'])[2]"));
		...
		Thread.sleep(5000);
		WebElement page30 = driver.findElement(By.xpath("(//*[@class='paginationGridRecordDisp ng-binding'])[2]"));
		...
		WebElement newpage20 = driver.findElement(By.xpath("(//*[@class='paginationGridRecordDisp ng-binding'])[2]"));
		...
		WebElement fwdpage = driver.findElement(By.xpath("(//span[@class='fa fa-angle-right'])[2]")); 
		...
		WebElement bckpage = driver.findElement(By.xpath("//span[@class='fa fa-angle-left']"));  
		...
		WebElement fastfwdpage = driver.findElement(By.xpath("(//span[@class='fa fa-angle-double-right'])[2]")); 
		...
		WebElement fastbckpage = driver.findElement(By.xpath("//span[@class='fa fa-angle-double-left']")); 
		fastbckpage.click();
		Thread.sleep(7000);
		...
		WebElement fromdate = driver.findElement(By.xpath("(//*[@uib-datepicker-popup='dd/MMM/yyyy'])[3]"));
		fromdate.click();
		Thread.sleep(3000);
		WebElement monthpick = driver.findElement(By.xpath("(//*[@aria-live='assertive'])[2]"));
		monthpick.click();
		Thread.sleep(3000);
		...
		WebElement fromday = driver.findElement(By.xpath("(//*[@type='button']/span [text() ='18'])[2]"));
		fromday.click();
		Thread.sleep(3000);

		WebElement todate = driver.findElement(By.xpath("(//*[@uib-datepicker-popup='dd/MMM/yyyy'])[4]"));
		todate.click();
		Thread.sleep(3000);
		WebElement to_day = driver.findElement(By.xpath("(//*[@type='button']/span [text() ='23'])[2]"));
		to_day.click();
		Thread.sleep(3000);
		sear.click();
		Thread.sleep(7000);
	...
	public void web_Result_has_to_be_displayed_to_the_user_as_per_the_search_combinations() throws Throwable {
	    Thread.sleep(3000);
	    driver.close();
	}
}