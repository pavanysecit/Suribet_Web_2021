...
public class Web_Poker_MultipleDraws_PlaceBet_CancelBet_Validations extends Web_VirtualPoker_URL_OnlineLogin {
	WebDriver driver;
	
	public Web_Poker_MultipleDraws_PlaceBet_CancelBet_Validations() throws Exception {
	...
	public void web_Chrome_browser_suribet_website_valid_URL_virtual_poker_module_place_bet_selecting_multiple_draws() throws Throwable {
