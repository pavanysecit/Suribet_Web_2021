...
public class Web_Poker_PaybyCard_Place_Cancel_Bets_TimeLapseCancelBets_Validations {
	WebDriver driver;
	...
	public void web_Chrome_browser_suribet_website_valid_URL_virtual_poker_module_place_bet_and_pay_the_amount_via_card_PAY_BY_CARD_option() throws Throwable {
	   
	}

	@When("^Web: Login to suribet website with valid login details, Click on VirtualPoker module link and place bet$")
	public void web_Login_to_suribet_website_with_valid_login_details_Click_on_VirtualPoker_module_link_and_place_bet() throws Throwable {
		...
		//Select the Numbers from the Board top place the bet 
		...
		submit.click();
		Thread.sleep(10000);
		WebElement cardbalance = driver.findElement(By.xpath("//*[@id='spnUserBalance']/small")); 
	...
	public void web_Select_PAY_BY_CARD_option_and_fill_the_card_details_and_accept_the_pop_up() throws Throwable {
		...
		String cbal=  cardbalance.getText().replaceAll("[^0-9.]", "");

		double numbal1 =Double.parseDouble(cbal);
		driver.findElement(By.cssSelector(".log_off.click_effect_JS")).click();
		Thread.sleep(7000);
	...
	@Then("^Web: Successfull cancelling bet user message is displayed to user in virtual poker module$")
	public void web_Successfull_cancelling_bet_user_message_is_displayed_to_user_in_virtual_poker_module() throws Throwable {
