...
public class Web_Poker_AccountSummaryPage_Validations extends Web_VirtualPoker_URL_OnlineLogin {
	WebDriver driver;
	
	public Web_Poker_AccountSummaryPage_Validations() throws Exception {
	...
	public void web_Chrome_browser_suribet_website_valid_URL_Poker_module_valid_logins_Account_summary_page() throws Throwable {
	...
	public void web_Navigate_to_account_summary_page_and_modify_the_search_pattern_like_date_module_row_length_and_filter_date_selections() throws Throwable {
		...
		expectedvalues1.add("SlotGames"); 
		expectedvalues1.add("Live Roulette");
		expectedvalues1.add("Lotto"); 
		expectedvalues1.add("Sport Betting");
		expectedvalues1.add("Skinfiri");
		expectedvalues1.add("Virtual Sport");
		expectedvalues1.add("Virtual Skinfiri");
		expectedvalues1.add("Tjekre Tjekre");
		expectedvalues1.add("Virtual Roulette");
		expectedvalues1.add("BlackJack");
		expectedvalues1.add("Virtual Poker");
		expectedvalues1.add("Virtual Keno");
		expectedvalues1.add("Pai Gow Poker");
		expectedvalues1.add("Virtual Baccarat");
...
//		prod.selectByVisibleText("Virtual Sport");
//		System.out.println("Selected Virtual Sport product from the select dropdown");
//		Thread.sleep(5000);
//
...
//		if(row1.getText().contains("//ul[@ng-repeat='bets in globalbetDetailsCtrl.betdetails.JSONDATA.rows']")) {
//
...
//		}
		...
		prod.selectByVisibleText("Virtual Poker");
		System.out.println("Selected Virtual Poker product from the select dropdown");
		Thread.sleep(5000);
	...
	public void web_Result_has_to_be_displayed_as_per_the_search_combinations_in_Poker_module() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}