...
public class Web_LiveSpin2Win_Login_Home_Validations {
WebDriver driver;
	...
	@When("^Web: Open the chrome browser, Enter the valid suribet URL, Click on live Spin(\\d+)Win module link, enter valid and invalid login details and click on home button$")
	public void web_Open_the_chrome_browser_Enter_the_valid_suribet_URL_Click_on_live_Spin_Win_module_link_enter_valid_and_invalid_login_details_and_click_on_home_button(int arg1) throws Throwable {
		...
		WebElement LiveRoulette = driver.findElement((By.xpath("(//*[@href='/Betting/LiveRoulette/'])[2]")));
		LiveRoulette.click();
		Thread.sleep(3000);	
	
		/*
		 * Landed to the Live Roulette game page
		...
		WebElement LiveRoulette1 = driver.findElement((By.xpath("(//*[@href='/Betting/LiveRoulette/'])[2]")));
		LiveRoulette1.click();
		Thread.sleep(3000);	

		WebElement close1 = driver.findElement(By.xpath("//*[@class='sidebar_close']")); 
		wait1.until(ExpectedConditions.visibilityOf(close1));
		close1.click();
	...
	@Then("^Web: User should able to see the live Spin(\\d+)Win module link in the home page and should see live Spin(\\d+)Win module home page after login & clicking on live Spin(\\d+)Win module$")
	public void web_User_should_able_to_see_the_live_Spin_Win_module_link_in_the_home_page_and_should_see_live_Spin_Win_module_home_page_after_login_clicking_on_live_Spin_Win_module(int arg1, int arg2, int arg3) throws Throwable {
