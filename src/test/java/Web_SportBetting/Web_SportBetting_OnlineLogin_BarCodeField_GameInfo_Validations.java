...
public class Web_SportBetting_OnlineLogin_BarCodeField_GameInfo_Validations extends Web_SportBetting_URL_OnlineLogin {
WebDriver driver;

	public Web_SportBetting_OnlineLogin_BarCodeField_GameInfo_Validations() throws Exception {
	...
	public void web_Place_bet_and_get_the_slip_id_and_cancel_the_bet_and_input_the_same_slip_id_in_barcode_field_and_verify_the_status_and_the_fields_in_the_slip_generator() throws Throwable {
		...
		WebElement CurrentSlip = driver.findElement(By.xpath("//*[@class='ul_clear slipgrid_d slipgrid_3']/li")); 
		String slip = CurrentSlip.getText();
		System.out.println("Slip number for: "+ slip);
		WebElement cdate = driver.findElement(By.xpath("//*[@class='ul_clear slipgrid_d slipgrid_3']/li[3]")); 
		...
		WebElement SlipID = driver.findElement(By.xpath("//div[@class='id_date_wrapper']/span[2]"));  
		...
		WebElement SD_status = driver.findElement(By.xpath("//td[@class='cancelled']"));    
		...
		driver.findElement(By.xpath("//*[@class='fa fa-times close_popup_JS ']")).click();
		Thread.sleep(2000);
