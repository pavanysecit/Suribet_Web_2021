...
public class Web_SportBetting_InvalidLogin_Validations extends Web_SportBetting_URL{
	WebDriver driver;

	@Given("^Web: Chrome browser, suribet website valid URL, sports betting module, invalid login details$")
	public void web_Chrome_browser_suribet_website_valid_URL_virtual_roulette_module_invalid_login_details() throws Throwable {
	...
	public void web_Try_to_login_with_invalid_different_combinations_under_all_modes_of_login_methods() throws Throwable {
		...
		WebElement upmatch = driver.findElement(By.xpath("//*[@class='position-relative d-flex flex-row ng-scope'][1]/span"));
		upmatch.click();
		Thread.sleep(3000);
