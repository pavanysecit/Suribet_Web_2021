...
public class Web_SportBetting_Login_Home_Validations {
	WebDriver driver;
	...
	public void web_Open_the_chrome_browser_Enter_the_valid_suribet_URL_Click_on_SportsBetting_module_link_enter_valid_and_invalid_login_details_and_click_on_home_button() throws Throwable {
		...
		WebElement Sports = driver.findElement((By.xpath("(//li[@ng-repeat='x in headerCtlr.topMenus'])[17]/a")));
		String sgames1 = Sports.getText();
		System.out.println("Sports Game dropdown: " +sgames1);	
		...
		Thread.sleep(2000);
		// Selecting the VirtualRoulette game from the dropdown
		WebElement subMenuOption = driver.findElement(By.xpath("(//a[(@href= '/Betting/SportBetting/')])[2]")); 
		System.out.println("Dropdown visible: "+subMenuOption.isDisplayed());
		//Mouse hover menuOption 'SPORT BETTING'
		actions.moveToElement(subMenuOption).click().build().perform();
		Thread.sleep(2000);
		System.out.println("Done Mouse hover and selecting 'SPORT BETTING' from Menu");
		...
		System.out.println("After Virtual Roulette game loaded, account state is in logoff condition and verified: "+ UID.isDisplayed());
		...
		WebElement sportbetting = driver.findElement((By.xpath("(//li[@ng-repeat='x in headerCtlr.topMenus'])[17]/a")));
		actions.moveToElement(sportbetting).perform();
		Thread.sleep(2000);
		WebElement subMenuOption1 = driver.findElement(By.xpath("(//a[(@href= '/Betting/SportBetting/')])[2]")); 
		actions.moveToElement(subMenuOption1).click().build().perform();
		Thread.sleep(10000);
		System.out.println("Sport betting is selected from the dropdowns");
	...
	@Then("^Web: User should able to see the SportsBetting module link in the home page and should see SportsBetting module home page after login & clicking on SportsBetting module$")
	public void web_User_should_able_to_see_the_SportsBetting_module_link_in_the_home_page_and_should_see_SportsBetting_module_home_page_after_login_clicking_on_SportsBetting_module() throws Throwable {
