...
public class Web_VirtualSkinfiri_AccountSummaryPage_Validations extends Web_VirtualSkinfiri_URL_OnlineLogin {
	WebDriver driver;
	
	public Web_VirtualSkinfiri_AccountSummaryPage_Validations() throws Exception {
	...
	public void web_Chrome_browser_suribet_website_valid_URL_virtual_skinfiri_module_valid_logins_Account_summary_page() throws Throwable {
	...
	public void web_Navigate_to_account_summary_page_and_modify_the_search_pattern_like_date_module_row_length() throws Throwable {
		...
		prod.selectByVisibleText("Tjekre Tjekre");
		System.out.println("Selected Tjekre Tjekre product from the select dropdown");
		Thread.sleep(5000);
		...
		if(row1.getText().contains("Tjekre Tjekre")) {
		...
		//Select the virtual skinfiri module for further more validations
		prod.selectByVisibleText("Virtual Skinfiri");
		System.out.println("Selected Virtual Skinfiri product from the select dropdown");
		Thread.sleep(5000);
		...
		//As only 23 records are available for the verification have taken the available records for validations
		...
		Assert.assertTrue(page20.getText().contains("Records: 1 - 2"));
		...
		Assert.assertTrue(page30.getText().contains("Records: 1 - "));
