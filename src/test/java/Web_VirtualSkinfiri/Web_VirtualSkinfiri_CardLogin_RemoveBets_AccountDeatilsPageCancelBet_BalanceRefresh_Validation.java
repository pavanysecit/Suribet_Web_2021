...
public class Web_VirtualSkinfiri_CardLogin_RemoveBets_AccountDeatilsPageCancelBet_BalanceRefresh_Validation extends Web_VirtualSkinfiri_URL_OnlineLogin {
	WebDriver driver;
	
	
	public Web_VirtualSkinfiri_CardLogin_RemoveBets_AccountDeatilsPageCancelBet_BalanceRefresh_Validation() throws Exception {
	...
	public void web_Chrome_browser_suribet_website_valid_URL_Draw_details_skinfiri_table_stake_amount_place_bet_balance_no_of_rows_account_details_page_cancel_bet_alert_cancel_the_bet() throws Throwable {
	...
	public void web_Login_to_suribet_website_with_valid_login_details_Click_on_VirtualSkinfiri_module_link_change_to_card_mode_of_payment() throws Throwable {
		...
		String alterStr = driver.findElement(By.xpath("//ul[@class='ul_clear  v_s_match_list']/li[6]/span[2]")).getText(); 
		...
		WebElement remove = driver.findElement(By.xpath("//*[@ng-click='VDGCtr.removeCartFun(a.betNumber,a.drawNumber)']")); 
		remove.click();
		Thread.sleep(2000);
		remove.click();
		Thread.sleep(1000);
...
//		WebElement Confirm = driver.findElement(By.xpath("//div[@ng-click='globalrouletteCtlr.PlaceBetDetails(false,false)']"));
		...
		//FORWARD AND PLACE BET WITHOUT LOGIN TO THE VirtualSkinfiri
		Forward.click();
		Thread.sleep(2000);
		//		Confirm.click();
		//		Thread.sleep(2000);
		...
		WebElement slipdate = driver.findElement(By.xpath("//*[@class='vgl_head']/tbody/tr[2]/td[2]/span"));
		System.out.println("Draw from from the Cancel Slip details: "+slipdate.getText());
		String alterDrawSlip = slipdate.getText().substring(12).replaceAll("[^0-9]","");
		Assert.assertEquals(alterDraw, alterDrawSlip);
		System.out.println("Validation is successfull for cancelling the draw");
		Thread.sleep(1500);
		driver.findElement(By.xpath("//*[@ng-show='cancelbutton']")).click();
		Thread.sleep(1500);
	...
	@Then("^Web: Cancel the placed bet and accept all the alerts with validation messages and verify the amount being deposited and refreshed after cancelling the bets in Virtual skinfiri module$")
	public void web_Cancel_the_placed_bet_and_accept_all_the_alerts_with_validation_messages_and_verify_the_amount_being_deposited_and_refreshed_after_cancelling_the_bets_in_Virtual_skinfiri_module() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}