...
public class Web_VirtualRoulette_CardLogin_TimeLapseCancelBets_BalanceUpdate_Validations extends Web_VirtualRoulette_URL_CardLogin{
	WebDriver driver;
	
	public Web_VirtualRoulette_CardLogin_TimeLapseCancelBets_BalanceUpdate_Validations() throws Exception {
		driver = Web_VirtualRoulette_URL_CardLogin();
	}

	@Given("^Web: Chrome browser, suribet website valid URL, virtual roulette module, place bet, time period, balance$")
	public void web_Chrome_browser_suribet_website_valid_URL_virtual_roulette_module_place_bet_time_period_balance() throws Throwable {
	...
	public void web_Place_bet_and_cancel_bet_after_min_and_validate_the_message_and_check_the_bet_status_after_time_lapse_cancellation_in_account_summary_tab_and_verify_the_updation_of_main_balance(int arg1) throws Throwable {
		...
		WebElement Pick31 = driver.findElement(By.xpath("//span[@bettypepickid='32']"));
		WebElement Pick35 = driver.findElement(By.xpath("//span[@bettypepickid='36']"));
