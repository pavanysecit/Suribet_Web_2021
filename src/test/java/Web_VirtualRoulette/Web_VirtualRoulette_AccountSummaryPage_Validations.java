...
public class Web_VirtualRoulette_AccountSummaryPage_Validations extends Web_VirtualRoulette_URL_OnlineLogin {
	WebDriver driver;
	
	public Web_VirtualRoulette_AccountSummaryPage_Validations() throws Exception {
