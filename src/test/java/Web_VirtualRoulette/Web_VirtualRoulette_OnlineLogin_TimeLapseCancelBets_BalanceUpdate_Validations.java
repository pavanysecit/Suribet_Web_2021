...
public class Web_VirtualRoulette_OnlineLogin_TimeLapseCancelBets_BalanceUpdate_Validations extends Web_VirtualRoulette_URL_OnlineLogin {
	WebDriver driver;
	
	public Web_VirtualRoulette_OnlineLogin_TimeLapseCancelBets_BalanceUpdate_Validations() throws Exception {
