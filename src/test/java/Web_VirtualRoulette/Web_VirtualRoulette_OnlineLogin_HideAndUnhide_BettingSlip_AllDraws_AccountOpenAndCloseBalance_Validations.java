...
public class Web_VirtualRoulette_OnlineLogin_HideAndUnhide_BettingSlip_AllDraws_AccountOpenAndCloseBalance_Validations extends Web_VirtualRoulette_URL_OnlineLogin {
	WebDriver driver;
	
	public Web_VirtualRoulette_OnlineLogin_HideAndUnhide_BettingSlip_AllDraws_AccountOpenAndCloseBalance_Validations() throws Exception {
	...
	public void web_note_the_login_balance_and_click_on_the_hide_and_un_hide_buttons_located_on_all_draws_and_betting_slip_columns_and_place_bets_and_check_the_balance_deductions_and_logout_and_relogin_and_verify_the_balance_reflected_to_the_user() throws Throwable {
		...
		WebElement Pick22 = driver.findElement(By.xpath("//span[@bettypepickid='23']"));
		WebElement Pick23 = driver.findElement(By.xpath("//span[@bettypepickid='24']"));
