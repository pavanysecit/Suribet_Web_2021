...
public class Web_VirtualRoulette_Login_Home_Validations {
	WebDriver driver;
...
//		WebDriverWait wait = new WebDriverWait(driver, 120);
		...
		WebElement subMenuOption = driver.findElement(By.xpath("(//a[(@href= '/Spin2Win/Spin2Win/')])[3]")); 
		...
		Thread.sleep(2000);
		WebElement subMenuOption1 = driver.findElement(By.xpath("(//a[(@href= '/Spin2Win/Spin2Win/')])[2]")); 
	...
	public void web_Open_the_chrome_browser_Enter_the_valid_suribet_URL_Click_on_VirtualRoulette_module_link_enter_valid_and_invalid_login_details_and_click_on_home_button() throws Throwable {
	...
	@Then("^Web: User should able to see the VirtualRoulette module link in the home page and should see VirtualRoulette module home page after login & clicking on VirtualRoulette module$")
	public void web_User_should_able_to_see_the_VirtualRoulette_module_link_in_the_home_page_and_should_see_VirtualRoulette_module_home_page_after_login_clicking_on_VirtualRoulette_module() throws Throwable {
