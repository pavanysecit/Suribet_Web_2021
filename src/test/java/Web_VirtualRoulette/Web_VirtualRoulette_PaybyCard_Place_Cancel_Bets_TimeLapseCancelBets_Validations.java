...
public class Web_VirtualRoulette_PaybyCard_Place_Cancel_Bets_TimeLapseCancelBets_Validations extends Web_VirtualRoulette_URL{
	WebDriver driver;
	...
	public void web_Chrome_browser_suribet_website_valid_URL_virtual_roulette_module_place_bet_and_pay_the_amount_via_card_PAY_BY_CARD_option() throws Throwable {
		driver = Web_VirtualRoulette_URL();
		Thread.sleep(2000);
	}

	@When("^Web: Login to suribet website with valid login details, Click on VirtualRoulette module link and place bet$")
	public void web_Login_to_suribet_website_with_valid_login_details_Click_on_VirtualRoulette_module_link_and_place_bet() throws Throwable {
	...
	public void web_Select_PAY_BY_CARD_option_and_fill_the_card_details_and_accept_the_pop_up() throws Throwable {
		...
		//clicking on Draw details to place bet for the current draw 
		WebElement DrawNO = driver.findElement(By.xpath("//ul[@class='ul_clear']//li[5]"));
		DrawNO.click();
		Thread.sleep(2000);
...
//		//Assert.assertEquals("Time limit Passed!", cancelbet.getText());
	...
	@Then("^Web: Successfull cancelling bet user message is displayed to user in Virtual Roulette module$")
	public void web_Successfull_cancelling_bet_user_message_is_displayed_to_user_in_Virtual_Roulette_module() throws Throwable {
