...
public class Web_VirtualRoulette_ChipDenominations_Addition_RefreshPage_Validations extends Web_VirtualRoulette_URL_OnlineLogin {
	WebDriver driver;
	
	public Web_VirtualRoulette_ChipDenominations_Addition_RefreshPage_Validations() throws Exception {
