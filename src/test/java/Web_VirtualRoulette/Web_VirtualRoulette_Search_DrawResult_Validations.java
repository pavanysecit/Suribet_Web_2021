...
public class Web_VirtualRoulette_Search_DrawResult_Validations extends Web_VirtualRoulette_URL_OnlineLogin {
private static final TimeUnit HOURS = null;
WebDriver driver;

	public Web_VirtualRoulette_Search_DrawResult_Validations() throws Exception {
	...
	public void web_Change_the_dates_and_verify_under_search_is_selected_all_draw_results_are_displayed_to_user_in_draw_result_tabs_with_and_without_win_combinations() throws Throwable {
		...
		WebElement DrawResult = driver.findElement(By.className("R_resultH"));
		...
		WebElement Dinput = driver.findElement(By.xpath("//*[@ng-model='globalrouletteCtlr.FilterDrawNum']")); 
		...
		WebElement cdraw = driver.findElement(By.xpath("//div[@class='c_draw_idTime_W']/div/span/label")); 
		System.out.println("Current draw num: "+cdraw.getText());
		int i=Integer.parseInt(cdraw.getText());  

		//previous draw results 
		WebElement previousdraw = driver.findElement(By.xpath("//li[@ng-repeat ='res in globalrouletteCtlr.VrResults track by $index']/div/div/span[2]")); 
