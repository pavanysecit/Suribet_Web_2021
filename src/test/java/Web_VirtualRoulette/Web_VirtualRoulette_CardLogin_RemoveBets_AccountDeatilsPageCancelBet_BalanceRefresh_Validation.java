...
public class Web_VirtualRoulette_CardLogin_RemoveBets_AccountDeatilsPageCancelBet_BalanceRefresh_Validation extends Web_VirtualRoulette_URL_OnlineLogin {
	WebDriver driver;
	
	public Web_VirtualRoulette_CardLogin_RemoveBets_AccountDeatilsPageCancelBet_BalanceRefresh_Validation() throws Exception {
...
//		WebDriverWait wait1 = new WebDriverWait(driver, 20);
		...
		WebElement Pick14 = driver.findElement(By.xpath("//span[@bettypepickid='13']"));
		Pick2.click();
		Thread.sleep(1000);
		Pick28.click();
		Thread.sleep(1000);
	...
	public void web_Login_to_suribet_website_with_valid_login_details_Click_on_VirtualRoulette_module_link_change_to_card_mode_of_payment() throws Throwable {
	...
	@Then("^Web: Cancel the placed bet and accept all the alerts with validation messages and verify the amount being deposited and refreshed after cancelling the bets in Virtual Roulette module$")
	public void web_Cancel_the_placed_bet_and_accept_all_the_alerts_with_validation_messages_and_verify_the_amount_being_deposited_and_refreshed_after_cancelling_the_bets_in_Virtual_Roulette_module() throws Throwable {
		driver.quit();
	}
}